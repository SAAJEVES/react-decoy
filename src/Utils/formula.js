export const newPopulation = (value) => {
  ...
  switch (valueLen) {
    case 4:
      return `${valueStr.slice(0, 1)},${valueStr.slice(1)}`;
      break;
    case 5:
    ...
    case 6:
      ...
      break;
    case 7:
      return `${valueStr.slice(0, 1)},${valueStr.slice(1, 4)},${valueStr.slice(4)}`;
      break;
    case 8:
    ...
    case 9:
      ...
      break;
    case 10:
      return `${valueStr.slice(0, 1)},${valueStr.slice(1, 4)},${valueStr.slice(4, 7)},${valueStr.slice(7)}`;
      break;
    default:
      return value
      break;
